...
<!-- -->
```
1.  **步骤二：上传数据到AI工具** --- 使用Kimi的文件上传功能

```{=html}
<!-- -->
```
1.  **步骤三：提出分析需求** --- 用自然语言描述你想分析什么

```{=html}
<!-- -->
```
1.  **步骤四：解读和验证AI的分析结果** --- 检查AI的结论是否合理，补充业务洞察

```{=html}
<!-- -->
```
1.  **步骤五：制定行动方案** --- 基于分析结果，提出具体的业务策略
...
<!-- -->
```
2.  设计一个"人机协作"的优化版分析方案

```{=html}
<!-- -->
```
2.  撰写反思总结：AI时代，你的核心竞争力是什么？
