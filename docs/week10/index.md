...
| 数据集 | 说明 | 下载 |
|---|---|---|
| [channel_data.csv](/data/channel_data.csv) | 全渠道月度数据，用于渠道分析 | [下载](/data/channel_data.csv) |
| [transaction_data.csv](/data/transaction_data.csv) | 订单商品明细，用于渠道分布分析 | [下载](/data/transaction_data.csv) |
