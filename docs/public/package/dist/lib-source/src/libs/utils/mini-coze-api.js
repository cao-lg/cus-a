...
import { uploadFile, getEnv, ENV_TYPE } from "@tarojs/taro";
...
export class MiniCozeApi extends CozeAPI {
    constructor(_a) {
        ...
        super(Object.assign(Object.assign({}, config), { axiosOptions: Object.assign(Object.assign({}, (axiosOptions || {})), { validateStatus: () => true }) }));
    ...
    makeRequest(apiUrl, method, body, isStream, options) {
        if (getEnv() === ENV_TYPE.WEB || !isStream) {
    ...
    requestMiniSse(apiUrl, method, body, options, retryNum = 0) {
        ...
        return __asyncGenerator(this, arguments, function* requestMiniSse_1() {
            ...
            function refreshTokenAndRetry(code = -1, msg = "unknown error") {
                return __awaiter(this, void 0, void 0, function* () {
                    if (retryNum === 0) {
                        yield self.refreshToken(oldToken);
    ...
    mixTaroUpload() {
        if (getEnv() !== ENV_TYPE.WEB) {
            this.files.upload = (params, options) => {
                return this._uploadFile(params, options);
            };
        }
    }
    _uploadFile(params, options, retryNum = 0) {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function* () {
            const url = `${(_a = this.baseURL) !== null && _a !== void 0 ? _a : ""}/v1/files/upload`;
            const oldToken = this.token;
            try {
                const rawResult = yield uploadFile({
                    url,
                ...
                if (code !== 0 || !data) {
                    if (this.isAuthErrorCode(code || rawResult.statusCode) &&
                        ...
                        return yield this._uploadFile(params, options, retryNum + 1);
                    }
                ...
                throw new MiniChatError(-1, "upload file failed");
            }
        });
    }
}
