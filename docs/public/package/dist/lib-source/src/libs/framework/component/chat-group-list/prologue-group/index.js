...
const PrologueChatMessage = ({ isShowDivide, isShowSuggestion, nextSectionId }) => {
    ...
    const i18n = useI18n();
    if (!prologueChatGroup) {
        return null;
    }
    return (_jsxs(View, { children: [isShowDivide ? (_jsxs(Spacing, Object.assign({ gap: 20, className: styles["divide-container"], verticalCenter: true, horizontalCenter: true }, { children: [_jsx(View, { className: styles["divide-line"] }), _jsx(Text, { children: i18n.t("clearContextDivide") }), _jsx(View, { className: styles["divide-line"] })] }))) : null, _jsx(ChatGroup, { chatGroup: prologueChatGroup, isShowSuggestion: isShowSuggestion })] }));
};
